...
export default function Header() {
  ...
  return (
    <header className='w-full mt-4 mr-2 pr-5 fixed rounded-full h-24 bg-color-head  flex items-center justify-between 850pxutil:w-screen 850pxutil:m-0 850pxutil:rounded-none'>
      <Image
